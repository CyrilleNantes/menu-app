...
urlpatterns = [
    ...
    path("famille/membres-secondaires/ajouter/", views.ajouter_membre_secondaire, name="ajouter_membre_secondaire"),
    path("famille/membres-secondaires/<int:profile_id>/retirer/", views.retirer_membre_secondaire, name="retirer_membre_secondaire"),
    ...
    path("planning/<int:plan_id>/repas/<int:meal_id>/dish/", views.ajouter_dish, name="ajouter_dish"),
    path("planning/<int:plan_id>/repas/<int:meal_id>/dish/<int:dish_id>/retirer/", views.retirer_dish, name="retirer_dish"),
    ...
    path("profil/calendar/", views.choisir_calendar, name="choisir_calendar"),
    # OAuth Google
